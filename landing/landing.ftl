<div id="widgetVue3Template" style="margin: 20px">
  ...
  <html lang="en">
    <head>
      ...
      <title>Evenly - App Landing Page</title>
            ...
            <div class="col-lg-4 col-11">
              <div class="tm-brand-container tm-bg-white-transparent">
                ...
                <div class="tm-brand-texts">
                  <h1 class="text-uppercase tm-brand-name">Evenly</h1>
                  <p class="small">landing page</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 tm-home-container">
              <div class="text-white tm-home-left">
                ...
                <p class="tm-home-text">
                  ...
                  framework. Please tell your friends about TemplateMo. Thank
                  you.
                </p>
                <a href="#tmFeatures" class="btn btn-primary">Learn More</a>
              </div>
              <div class="tm-home-right">
                <img :src="mobileScreenImage" alt="App on Mobile mockup" />
              </div>
            </div>
          </section>
          ...
          <div class="row" id="tmFeatures">
            <div class="col-lg-4">
              <div class="tm-bg-white-transparent tm-feature-box">
                ...
                <p class="text-center">
                  Download and use this layout for your sites. Total 5 HTML
                  pages included.
                </p>
              </div>
            </div>
            ...
            <div class="col-lg-4">
              <div class="tm-bg-white-transparent tm-feature-box">
                ...
                <p class="text-center">
                  You are NOT allowed to redistribute this template on any
                  download site.
                </p>
              </div>
            </div>
            ...
            <div class="col-12 tm-call-to-action-col">
              ...
              <div class="tm-bg-white tm-call-to-action-text">
                ...
                <p class="tm-call-to-action-description">
                  You may browse
                  <a rel="nofollow" href="https://www.toocss.com">Too CSS</a>
                  website for the collection of CSS templates for your projects.
                  Aliquam erat volutpat. Nulla eros est, imperdiet vel feugiat
                  non, ullamcorper mattis nulla.
                </p>
